      ...
      <div ref={shiftRef} style={{ position: "absolute", inset: 0 }}>
        <span
          ...
          style={{
            ...
            left: "-10%",
            top: "2%",
            background: `radial-gradient(circle, ${colors.accent}, transparent 72%)`,
            opacity: 0.2,
          }}
        />
        <span
          ...
          style={{
            ...
            right: "-8%",
            top: "34%",
            background: "radial-gradient(circle, #34A853, transparent 72%)",
            opacity: 0.15,
          }}
        />
        <span
          ...
          style={{
            ...
            left: "16%",
            top: "74%",
            background: `radial-gradient(circle, ${colors.primary}, transparent 74%)`,
            opacity: 0.13,
          }}
        />
        <span
          ...
          style={{
            ...
            left: "48%",
            top: "10%",
            background: `radial-gradient(circle, ${colors.gold}, transparent 72%)`,
            opacity: 0.12,
            animationDelay: "-6s",
          }}
        />
